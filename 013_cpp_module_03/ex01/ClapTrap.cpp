...
/*   Updated: 2024/08/27 18:10:41 by jmartos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "[ (CT) ClapTrap constructor called. " << _name << " appeared! ]" << std::endl;
}

/* Constructor de copia: crea una clase objeto "cpy" y lo copia a este mismo. */
ClapTrap::ClapTrap(const ClapTrap &copy_)
{
	std::cout << "[ (CT) ClapTrap copy constructor called. ]" << std::endl;
	*this = copy_;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "[ (CT) ClapTrap destructor called. ]" << std::endl;
}
