...
/*   Updated: 2024/09/27 18:58:12 by jmartos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScalarConverter::ScalarConverter(char *inputC_) : _inputC(inputC_), _inputCPP(), _imposible(), _value()
{
	std::cout << "[ Constructor called! ]" << std::endl;
	_inputCPP = static_cast<std::string>(inputC_);
	std::stringstream ss(_inputCPP);
	if (!(ss >> _value))
		_imposible = true;
}
